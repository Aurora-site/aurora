...
export const ui = {
  ru: {
    ...
    "pro.live.text": "Данные на странице обновляются каждые 5 минут.",
    ...
    "pro.scales.g.info":
      "Шкала геомагнитных бурь от G0 (нет бури) до G5 (экстремальная буря). Чем выше значение, тем сильнее и южнее может быть видно сияние.",
    "pro.scales.s": "S — радиационные бури",
    "pro.scales.s.info":
      "Шкала солнечных радиационных бурь от S0 до S5. Влияет на радиосвязь и авиаперелёты через полюса.",
    "pro.scales.r": "R — радиопомехи",
    "pro.scales.r.info":
      "Шкала радиопомех от R0 до R5, вызванных вспышками на Солнце. Влияет на КВ-радиосвязь на освещённой стороне Земли.",
    ...
    можете обратиться за помощью к гидам и туроператорам, которые занимаются этим
    профессионально.`,
    ...
    "aurora-murmansk.title":
      "Северное сияние в Мурманске 2026–2027 — когда ехать",
    "aurora-murmansk.description":
      "Сезон, лучшие месяцы, вероятность по Kp-индексу и проверенные точки для наблюдения северного сияния в Мурманске. Прогноз обновляется в реальном времени.",
  ...
  cn: {
    ...
    "Where.text1": `为了成功观赏极光，选择合适的地点非常重要。理想的地点是远离城市灯光的地方，在那里光污染不会妨碍您欣赏极光。选择高地或开阔的区域，确保视野开阔。`,
    "Where.text2": `别忘了安全：避免停在繁忙的道路上，并确保选择的地点适合停车和停留，特别是在夜间。`,
    /*Tours*/
    "Tours.title": "与专业向导一起的极光拍摄之旅。",
    "Tours.text": `如果您自己无法捕捉到极光，或者您是专门为此目的来到高纬度地区，并且时间非常有限，那么您可以寻求专业向导和旅行社的帮助，他们专门从事这项工作。`,

    /*Вторая страница для скаичивания приложения */
    "App.title": "极光",
    "App.app": "带通知的应用",
    "App.text1": `计划观赏极光吗？我们的应用程序是您的完美伴侣！获取准确的预测、Kp指数升高和太阳爆发的通知。不要让天气条件破坏您的冒险——始终领先一步！立即下载，开始您的魔幻之旅！`,
    "App.mini-title1": "将应用安装到您的手机上",

    "App.point1": "方便且及时",
    "App.point2": "一切简单明了",
    "App.point3": "没有不必要的信息",
    "App.point4": "可以指定地理位置",
    "App.point5": "有关于极光高概率的通知",
